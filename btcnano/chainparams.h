#ifndef LIGHTNING_BTCNANO_CHAINPARAMS_H
#define LIGHTNING_BTCNANO_CHAINPARAMS_H
...
struct chainparams {
	...
	const struct btcnano_blkid genesis_blockhash;
	const int rpc_port;
	const char *cli;
	const char *cli_args;
...
#endif /* LIGHTNING_BTCNANO_CHAINPARAMS_H */
