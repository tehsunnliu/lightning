#include <assert.h>
#include <btcnano/pullpush.c>
#include <btcnano/shadouble.c>
#include <btcnano/tx.c>
#include <btcnano/varint.c>
...
int main(void)
{
	...
	tx = btcnano_tx_from_hex(NULL, extended_tx, strlen(extended_tx));
	assert(tx);

	/* Canonical results from Nichola Dorier's
	 *	   http://n.btcnano.ninja/checktx
	 * With much thanks!
	 */
