#ifndef LIGHTNING_BTCNANO_BASE58_H
#define LIGHTNING_BTCNANO_BASE58_H
#include "config.h"
...
char *btcnano_to_base58(const tal_t *ctx, bool test_net,
			const struct btcnano_address *addr);
bool btcnano_from_base58(bool *test_net,
...
#endif /* LIGHTNING_BTCNANO_BASE58_H */
