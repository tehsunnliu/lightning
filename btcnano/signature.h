#ifndef LIGHTNING_BTCNANO_SIGNATURE_H
#define LIGHTNING_BTCNANO_SIGNATURE_H
#include "config.h"
...
bool check_tx_sig(struct btcnano_tx *tx, size_t input_num,
...
#endif /* LIGHTNING_BTCNANO_SIGNATURE_H */
