...
const struct chainparams networks[] = {
	...
	{.index = 5,
     ...
     .bip173_name = "btn",
     .genesis_blockhash = {{{.u.u8 = {0x04, 0x2a, 0xf1, 0x42, 0xd6, 0x07, 0x47, 0x2c, 0x0f, 0x08, 0x0c, 0xbc, 0x95, 0x7b, 0x70, 0x30, 0x43, 0x18, 0xbc, 0xcc, 0xee, 0x77, 0x7b, 0xa3, 0x0e, 0x0c, 0x78, 0x14, 0x43, 0xdf, 0x00, 0x00}}}},
     .rpc_port = 9556,
     .cli = "btcnano-cli",
     .cli_args = "",
     .dust_limit = 100000,
     .testnet = false},
    {.index = 6,
     .network_name = "btcnano-testnet",
     .bip173_name = "btt",
     .genesis_blockhash = {{{.u.u8 = {0x5a, 0x52, 0x6b, 0x83, 0xa4, 0xe5, 0xe4, 0xdb, 0x59, 0xfc, 0xc6, 0x9d, 0x08, 0x9d, 0x48, 0x83, 0x45, 0x36, 0x55, 0x28, 0x3f, 0xa6, 0x43, 0x0a, 0x98, 0x63, 0x25, 0xc4, 0xbc, 0x81, 0xd5, 0x06}}}},
     .rpc_port = 19556,
     .cli = "btcnano-cli",
     .cli_args = "-testnet",
     .dust_limit = 100000,
