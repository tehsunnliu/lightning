...
static bool btcnano_tx_eq(const struct btcnano_tx *tx1,
			  const struct btcnano_tx *tx2)
{
	u8 *lin1, *lin2;
	bool eq;
...
static bool channelseq(struct wallet_channel *c1, struct wallet_channel *c2)
{
	...
	if(p1->last_tx) {
		CHECK(btcnano_tx_eq(p1->last_tx, p2->last_tx));
	}
...
static bool test_channel_crud(const tal_t *ctx)
{
	...
	struct btcnano_txid *hash = tal(w, struct btcnano_txid);
	struct pubkey pk;
	...
	p.last_tx = btcnano_tx_from_hex(w, "", strlen(""));
	p.last_sig = sig;
	wallet_channel_save(w, &c1);
	CHECK_MSG(!wallet_err, tal_fmt(w, "Insert into DB: %s", wallet_err));
	CHECK_MSG(c2 = wallet_channel_load(w, c1.id), tal_fmt(w, "Load from DB"));
